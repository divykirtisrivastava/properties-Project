...
export default function AdminRegister() {
    let { setHaveAdmin , adminLogin} = useContext(UserContext)
...
//   console.log(data)
  ...
  let result = await axios.post('http://localhost:3000/api/adminSave', data, {
    headers:{
...
console.log(result)
 ...
 let result =  await adminLogin(email, password)
  ...
  return (
    <div>
      <div class="font-[sans-serif] bg-white max-w-4xl flex items-center mx-auto md:h-screen py-2 ">
      <div class="grid md:grid-cols-3 border-[1px] border-black items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-xl overflow-hidden">
        ...
        <form class="md:col-span-2 w-full py-6 px-6 sm:px-16" method='post' action='' onSubmit={handleSubmit}>
          <div class="mb-6">
          ...
          <div class="space-y-6">
            <div>
              ...
              <div class="relative flex items-center">
                ...
                type="text" required class="text-gray-800 bg-white border-[2px] border-black w-full text-sm px-4 py-2.5 rounded-md " placeholder="Enter name" />
            ...
            <div>
              <label class="text-gray-800 text-sm mb-2 block">Upload Image</label>
              <div class="relative flex items-center">
                <input 
              ...
              onChange={(e)=>setImage(e.target.files[0])}
                type="file" required class="text-gray-800 bg-white border border-gray-300 w-full text-sm px-4 py-2.5 rounded-md outline-blue-500" placeholder="Enter password" />
